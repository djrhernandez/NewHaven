...
EnemyFighter_Gnat::EnemyFighter_Gnat(EnemyType et, float p[3], float randFact)
		: EnemyFighter(et, p, randFact)
{
	init(p, randFact);
}

EnemyFighter_Gnat::~EnemyFighter_Gnat()
{
}

// Gets rid of the IRIX compiler warning...
void EnemyFighter_Gnat::init()
{
	EnemyFighter::init();
}

void EnemyFighter_Gnat::init(float *p, float randFact)
{
...
void EnemyFighter_Gnat::calcShootInterval()
{
	shootInterval = (int)((1.0 + FRAND * 5.0)/game->speedAdj);
}

void EnemyFighter_Gnat::move()
{
